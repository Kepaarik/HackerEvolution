import { GeneratorData, UpgradeData, Achievement, PrestigeUpgradeData, TechnologyData } from "./types";
...
export const GENERATORS: GeneratorData[] = [
  ...
  },
  {
    ...
    count: 0,
    chapter: 6,
    description: "Солнце теперь работает на вас. Профсоюз звонил, просило не комментировать.",
    unlockAtTotalEarned: 0,
    costGrowth: 1.17,
  ...
  },
  {
    ...
    condition: (s) =>
      ((s.generators?.spy_satellite ?? 0) +
        ...
        (s.generators?.moon_datacenter ?? 0)) >= 25,
    unlocked: false,
    icon: "🌍",
    rewardFragments: 3,
  },
